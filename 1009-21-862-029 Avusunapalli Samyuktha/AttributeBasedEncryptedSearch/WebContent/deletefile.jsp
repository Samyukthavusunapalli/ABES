...
<head>
<title>Efficient Document Retrieval</title>
			...
			<div id="logo">
				<div id="logo_text">
					<br /> <br /> <font size="5"><a href="index.html"><span
							class="logo_colour">Attribute-Based Encryption Approach for Storage, Sharing and Retrieval of Encrypted Data in the Cloud</span></a></font>
				</div>
			</div>
			<div id="menubar">
				<ul id="menu">
